...
var _LocationComponent = __webpack_require__(1);

var _LocationComponent2 = _interopRequireDefault(_LocationComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log(_LocationComponent2.default);
var CONSTANTS = {
  GAME_WIDTH: 80,
  GAME_HEIGHT: 24,
  CELL_WIDTH: 17,
...
function init() {
  ...
  var location = currentLevel.getTileByType('floor').getComponent(window.LocationComponent);
  var player = new window.Player(currentLevel, location.x, location.y);
  player.update();

  for (var i = 0; i < 40; i++) {
    var monsterLocation = currentLevel.getTileByType('floor').getComponent(window.LocationComponent);
    var monster = new window.Monster('kobold', currentLevel, monsterLocation.x, monsterLocation.y);
    monster.update();
...
var LocationComponent = function (_Component) {
